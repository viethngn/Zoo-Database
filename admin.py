...
if __name__ == "__main__":
	...
	if "insertNewEmployee" in form and "SSN" in form:
		SSN = form["SSN"].value
		...
		dbinterface.insertNewEmployee(SSN, FirstName, LastName, Gender, Address, City, State, Zipcode, DepartmentId, Email, Phone, SupervisorId, Salary)

	elif "insertNewEmployee" in form:
		dbinterface.showInsertNewEmployeeForm()

	elif "updateEmployeeInfo" in form and "Gender" in form:
		FirstName = form["FirstName"].value
		LastName = form["LastName"].value
		Gender = form["Gender"].value
		Address = form["Address"].value
	...
	elif "deleteEmpById" in form and "Id" in form:
		Id = form["Id"].value
		dbinterface.deleteEmpById(Id)

	elif "deleteEmpById" in form:
		dbinterface.showDeleteEmployeeForm()
		...
		dbinterface.showDefaultAdminPage()
